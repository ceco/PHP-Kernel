    ...
    class info {
        ...
        */
        public function error( $errno, $errmsg = null, $filename = null, $linenum = null, $vars = null ){
            ...
            //$this->kernel->templ->assign("_MESSAGE_", $errmsg );
            //$this->kernel->call_from("info","error",APP_ECHO_ON, $this->kernel->environment, "/index/" );
        ...
        */
        public function warning( $message ){
            ...
            $this->kernel->templ->assign("_MESSAGE_", $message );
            echo $this->kernel->call_from("info","warning",APP_ECHO_ON, $this->kernel->environment, DIRECTORY_SEPARATOR.DEFAULT_APPLICATION.DIRECTORY_SEPARATOR."usr".DIRECTORY_SEPARATOR );
        ...
        */
        public function info( $message ){
            ...
            $this->kernel->templ->assign("_MESSAGE_", $message );
            $this->kernel->call_from("info","info",APP_ECHO_ON, $this->kernel->environment, DIRECTORY_SEPARATOR.DEFAULT_APPLICATION.DIRECTORY_SEPARATOR."usr".DIRECTORY_SEPARATOR );
