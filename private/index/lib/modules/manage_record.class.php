    ...
    class manage_record {
        ...
        */
        public function submit_view (){
            ...
            if( $this->row = $this->getOne( $id ) ){
                $this->main->params_html = array_merge( $this->main->params_html, $this->row );
        ...
        */
        public function submit_edit (){
            ...
            if( $this->row = $this->getOne( $id ) ){
                $this->main->params_html = array_merge( $this->main->params_html, $this->main->html_special_chars($this->row) );
                $this->main->templ->assign("params", $this->main->params_html);
            }
        ...
        */
        public function last_insert_id() {
            ...
            return $this->main->db->getOne("SELECT LAST_INSERT_ID()");
